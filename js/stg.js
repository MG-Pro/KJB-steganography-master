...
const signalEnergy = 0.15; // чем выше значение, тем устойчивее к искажениям (+ заметнее)
const sigmaMin = -3;
const sigmaMax = 3;
const Repeat = 20; // количество встраиваний
const key1 = 124;
const key2 = 100;
const key3 = 155;
// *******************//
...
function getPxsBrightness(Pixel, PxNum, SignalEnergy) {
  ...
  let Y = 0.299 * Pixel[PxNum] + 0.587 * Pixel[PxNum + 1] + 0.114 * Pixel[PxNum + 2];
  if (Y == 0) {
    Y = 5 / SignalEnergy;
  }
